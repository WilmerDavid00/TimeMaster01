...
public final class ActivityMain2Binding implements ViewBinding {
  ...
  private ActivityMain2Binding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton add, @NonNull BottomNavigationView bottomNavigation,
      @NonNull ConstraintLayout constraintLayout, @NonNull FrameLayout frameContainer,
      @NonNull TextView fullName, @NonNull RecyclerView recyclerView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMain2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain2Binding((ConstraintLayout) rootView, add, bottomNavigation,
